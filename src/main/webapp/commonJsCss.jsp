...
<link rel="stylesheet" href="<%=contextPath%>/UI/libs/boostarap-dialog/bootstrap-dialog.min.css">
<link rel="stylesheet" href="<%=contextPath%>/UI/libs/bootstrap-multiselect/bootstrap-multiselect.min.css">
